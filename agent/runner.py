...
def run_agent(user_message: str, history: Optional[List[Dict[str, str]]] = None, max_steps: int = 5) -> AgentResponse:
    ...
    while step_count < max_steps:
        ...
        # Note: Gemini requires function call histories to be specific.
        # But since our generic chat doesn't fully handle multi-turn function history cleanly without native types,
        # we append text and then execute the tools.
